...
// NewGetUserWorkHistoryUnauthorized builds a hy_userWorkHistory service
// getUserWorkHistory endpoint Unauthorized error.
func NewGetUserWorkHistoryUnauthorized(body *GetUserWorkHistoryUnauthorizedResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// ValidateGetUserWorkHistoryUnauthorizedResponseBody runs the validations
// defined on getUserWorkHistory_Unauthorized_response_body
func ValidateGetUserWorkHistoryUnauthorizedResponseBody(body *GetUserWorkHistoryUnauthorizedResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
