...
var (
	// UserworkhistoryCollectionMap is a map of attribute names in result type
	// UserworkhistoryCollection indexed by view name.
	...
	// UserworkhistoryMap is a map of attribute names in result type
	// Userworkhistory indexed by view name.
