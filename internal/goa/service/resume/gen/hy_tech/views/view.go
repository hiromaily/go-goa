...
var (
	// TechCollectionMap is a map of attribute names in result type TechCollection
	...
	// TechMap is a map of attribute names in result type Tech indexed by view name.
