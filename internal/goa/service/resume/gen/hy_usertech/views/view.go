...
var (
	// UsertechCollectionMap is a map of attribute names in result type
	// UsertechCollection indexed by view name.
	...
	// UsertechMap is a map of attribute names in result type Usertech indexed by
	// view name.
