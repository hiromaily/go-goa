...
type TCompany struct { // company id
...
var TCompanyTableColumns = struct {
	ID        string
	Name      string
	CountryID string
	Address   string
	...
	ID:        "t_company.id",
	Name:      "t_company.name",
	CountryID: "t_company.country_id",
	Address:   "t_company.address",
	IsDeleted: "t_company.is_deleted",
	CreatedAt: "t_company.created_at",
	UpdatedAt: "t_company.updated_at",
}
...
var TCompanyWhere = struct {
	...
	CountryID: whereHelperint16{field: "`t_company`.`country_id`"},
	Address:   whereHelpernull_String{field: "`t_company`.`address`"},
...
var (
	tCompanyAllColumns            = []string{"id", "name", "country_id", "address", "is_deleted", "created_at", "updated_at"}
	tCompanyColumnsWithoutDefault = []string{"name", "country_id", "address"}
	tCompanyColumnsWithDefault    = []string{"id", "is_deleted", "created_at", "updated_at"}
	tCompanyPrimaryKeyColumns     = []string{"id"}
	tCompanyGeneratedColumns      = []string{}
)

type (
	// TCompanySlice is an alias for a slice of pointers to TCompany.
	// This should almost always be used instead of []TCompany.
...
func TCompanies(mods ...qm.QueryMod) tCompanyQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`t_company`.*"})
	}

	return tCompanyQuery{q}
}
