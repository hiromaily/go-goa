...
var TTechTableColumns = struct {
	...
	ID:        "t_tech.id",
	Name:      "t_tech.name",
	IsDeleted: "t_tech.is_deleted",
	CreatedAt: "t_tech.created_at",
	UpdatedAt: "t_tech.updated_at",
}
...
var (
	...
	tTechGeneratedColumns      = []string{}
)

type (
	// TTechSlice is an alias for a slice of pointers to TTech.
	// This should almost always be used instead of []TTech.
	TTechSlice []*TTech
...
func TTeches(mods ...qm.QueryMod) tTechQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`t_tech`.*"})
	}
